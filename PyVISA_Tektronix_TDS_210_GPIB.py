...
class TDS210():
    ...
    TDS_Dic={'Functions':['**Select Command To Execute**',
        ...
        'get_cursors_vbars','get_vbars_delta',],
        #/////////////////////////////////////////////ARGUMENTS///////////////////////////////////////////////////
        ...
        'Data: (None) Returns All Waveform Data Parameters','Curve: (None) Retrieve Data Specified By Data Source',
    ...
    def __str__(self):
        ...
        def gpib_send():
            ...
            TDS_CMDS={'Commands':['*******','****UTIL****','CAL:INTERNAL','AUTOSET EXECUTE','FACTORY','*RST',
                        ...
                        'CURSOR:VBARS:DELTA?',]}
            try:
                if not '?' in TDS_CMDS['Commands'][self.index]:
                ...
                if TDS_CMDS['Commands'][self.index]=='CURVE?':
                    Waveform_Data.focus()
                    Waveform_Data.delete('1.0','end')
                    Waveform_Data.insert('end',self.rtn_val)
                else:
